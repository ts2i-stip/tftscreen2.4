...
void setup() {
    ...
    int nbFontSize = 4;
    tft.setTextSize(nbFontSize);
    tft.fillRect(0, 0, 10 * (nbFontSize * (CARACTER_WIDTH + 1)) + 2,
    nbFontSize * CARACTER_HIGH + nbFontSize + 1, RED);
    tft.setCursor(1, 1);
    ...
    for (int i = 0; i < 4; i++) {
        ...
        steps[i].setMargins({CARACTER_WIDTH * steps[i].getFontSize() + 6, 4});
        steps[i].setPos({0, i * (CARACTER_HIGH * steps[i].getFontSize() + 10) + 10});
        steps[i].draw();
    }
    ...
    pBonnes.setTextColor(GREEN);
    pBonnes.setText("0000");
    ...
    pMauvaises.setTextColor(RED);
    pMauvaises.setText("0000");
...
void loop() {
    ...
    if (position1 >= valeurMin1 && position1 <= valeurMax1) {
        steps[0].setTextColor(GREEN);
        steps[0].draw();
        steps[1].setTextColor(YELLOW);
        steps[1].draw();
        ...
        if (position2 >= valeurMin2 && position2 <= valeurMax2) {
            steps[1].setTextColor(GREEN);
            steps[1].draw();
            steps[2].setTextColor(YELLOW);
            steps[2].draw();
            ...
            if (stepCycle == 3) {
                ...
                steps[2].setTextColor(GREEN);
                steps[2].draw();
                steps[3].setTextColor(YELLOW);
                steps[3].draw();
            }
